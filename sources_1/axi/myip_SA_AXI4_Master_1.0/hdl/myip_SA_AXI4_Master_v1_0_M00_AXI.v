...
module myip_SA_AXI4_Master_v1_0_M00_AXI #
(
...
(
    ...
    input  wire [1:0] C_M_MODE,  // 0: IDLE, 1: STORE_DATA, 2: LOAD_DATA
    input  wire [C_M_AXI_ADDR_WIDTH-1 : 0] C_M_OFF_MEM_ADDRA,
...
// accept the read data and response information.
    ...
    always @ (posedge M_AXI_ACLK) begin
        ...
        //The burst_write_active is asserted when a write burst transaction is initiated
            ...
            // Burst read complete. (M_AXI_RLAST)
            burst_read_active <= 0;
    end
    ...
    always @ (posedge M_AXI_ACLK) begin : NEXT_STATE_LOGIC
        if (M_AXI_ARESETN == 0) begin
            ...
            major_state <= C_M_MODE;
        end
    end


    always @ (posedge M_AXI_ACLK) begin : MAJOR_STATE_MACIHNE
        if (M_AXI_ARESETN == 0) begin
            mst_exec_state <= IDLE;
        end else begin
            case (major_state)
